...
GAS_DENSITY = 2.858
ONE_MPH = 0.44704
STATIONARY_BRAKE_TORQUE = 700 #Torque to hold the car at stationary, 700 Nm
...
class Controller(object):
    ...
    def control(self, current_vel, dbw_enabled, linear_vel, angular_vel):
        ...
        if not dbw_enabled:
            ...
            #rospy.logwarn("LPFiltered velocity: {0}".format(filtered_vel))
